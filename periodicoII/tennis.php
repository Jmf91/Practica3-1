...
<div id="centro">
    ...
    <table><tr><td><a href="futbol.php" class="futbol"></a></td><td><a href="tennis.php" class="tennis"></a></td><td><a href="NBA.php" class="NBA"></a></td><td><a href="F1.php" class="F1"></a></td><td><a href="ciclismo.php" class="ciclismo"></a></td><td><a href="natacion.php" class="natacion"></a></td></tr></table>
  	...
  	<div id="NombreSeccion">
    	<img src="img/iconos/tennis.png">
    	Tennis
    </div>
    <?php
    require_once "configuracion.inc";
	$conexion = new PDO( DB_DSN, DB_USUARIO, DB_CONTRASENIA );
    $consultaSQL = "SELECT * FROM noticias where secciones='Tennis' order by id DESC";
	$resultados = $conexion->query($consultaSQL);
	$numNoticia=0;
	foreach ($resultados as $fila ) {
		if($numNoticia==0){
    ...
    <div id="NoticiasDerecha">
        <section class="Publicidad">
            ...
            <a href="http://www.spannabisur.com"><img src="banner/publicidad4.gif" width="300px" vspace="5px" align="center"></a>
            <a href="http://www.estudioec.com"><img src="banner/publicidad5.bmp" width="300px" vspace="5px" align="center"></a>
        </section>   
    </div>
    </div>
